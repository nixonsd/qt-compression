...
QT_MOC_LITERAL(1, 12, 15), // "changeReadBytes"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "FileHandler\0changeReadBytes\0"
};
...
void FileHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeReadBytes((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FileHandler::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileHandler::changeReadBytes)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FileHandler::changeReadBytes(int _t1)
{
